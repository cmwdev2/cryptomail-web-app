            ...
            <Slider {...slickSettings} className="slide">
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        <Header inverted as="h1">
                            🌎 Attention is the world's most valuable resource, yet you give yours for free to strangers on the Internet on a daily basis...
                        </Header>
                    </Container>
                </Segment>
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        <Header inverted as="h1">
                            📥&nbsp; Your inbox is a todo list created by other people and companies that want your attention for free... Maybe this is why you hate email so much?
                        </Header>
                    </Container>
                </Segment>
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        <Header inverted as="h1">
                            🤔 It doesn't have to be like this.<br/>Crypto-currencies enable us to take back ownership of our attention by charging others who want it for it.
                        </Header>
                    </Container>
                </Segment>
                <Segment inverted vertical textAlign="center">
                ...
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>
                           You set your price for actions such as reading a message or replying to a message based on how much you value your time.
                        </p>
                    </Container>
                </Segment>
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        <Header inverted as="h1">
                           People and companies propose to pay you to read a message, reply to a message, have a 15-minutes zoom meeting, or watch a 5-minutes video.
                        </Header>
                    </Container>
                </Segment>
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>You choose what to read, when to read, who to reply to and what requested actions you are willing to do.</p>
                ...
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>Consider using cmail if you and others value your time, and you would like to get paid for spending your valuable time on other people and companies todo items.</p>
                    </Container>
                </Segment>
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>Consider using cmail if you want to reach specific people or companies with proposals for products or services that they would have never otherwise read nor respond to.</p>
                        <p>Consider using cmail if you need information or opinion form specific people or companies that you will never otherwise get.</p>
                    </Container>
                </Segment>
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>Cmail alpha release, an early release of the cmail service is now available for free to anyone on desktop and mobile.</p>
                ...
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>Cmail makes money by taking a small percentage fee out of every crypto-currency payment transaction executed on the platform.</p>
                ...
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>Messages sent orn cmail are end-to-end encrypted using strong encryption and can only be read by sender and receiver.
                ...
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>Being personal makes it more likely that other users will pay for your attention based on who you are and your work position.</p>
                        <p>If you plan to mainly use cmail to pay other users for their attention then your camil account can be fully anonymous.</p>
                        <Button color='green' onClick={(_) => window.location.href='/faq'}>
                            Learn more...
                        </Button>
                    </Container>
                ...
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>An anonymous collective of software designers from around the world who share a common vision for building innovative crypto software that put users first.</p>
                        <p>Any profits generated by cmail after paying for hosting costs are distributed between the DAO members.</p>
                        <Button color='green' onClick={(_) => window.location.href='/faq'}>
                            Learn more...
                        </Button>
                    </Container>
                ...
                <Segment inverted vertical textAlign="center">
                    <Container text className="active">
                        ...
                        <p>Cmail web app is open source software and is available for non-commercial use such as security audits and educational purposes.</p>
                        <p>Cmail server software is not open source quite yet but we intend to open source it for the beta release milestone.</p>
                        <Button color='green' onClick={(_) => window.location.href='/faq'}>
                            Learn more...
                        </Button>
                    </Container>
